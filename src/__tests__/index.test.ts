...
describe("VmPlugin", () => {
  ...
  describe("Metadata", () => {
    test("should have correct metadata", () => {
      ...
      expect(plugin.metadata.version).toBe("1.9.0");
    });
  });
  ...
  describe("Initialization", () => {
    ...
    it("should accept custom options", () => {
      ...
      expect(templates[0].parameters?.vmSize.defaultValue).toBe(
        "Standard_D4s_v3",
      );
    });
  });
  ...
  describe("Templates", () => {
    ...
    it("should include template files", () => {
      ...
      expect(vmTemplate.files?.createUiDefinition).toBe(

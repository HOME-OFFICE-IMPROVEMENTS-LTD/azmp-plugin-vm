...
describe("Scaling Module", () => {
  ...
  describe("createVmssDefinition", () => {
    ...
    it("throws when required values are missing", () => {
      expect(() =>
        createVmssDefinition({ name: "", vmSize: "" } as any),
      ).toThrow(/requires a VMSS name/);
    });
  });
  ...
  describe("scale:vmss.definition helper", () => {
    it("renders VMSS definition through Handlebars helper", () => {
      ...
      const result = helpers["scale:vmss.definition"]({
        name: "web-vmss",
        vmSize: "Standard_B2s",
      });
  ...
  describe("Auto-scaling Policy", () => {
    it("creates a basic auto-scaling policy", () => {
      const policyOptions: AutoScalePolicyOptions = {
        ...
        targetResourceUri:
          '[resourceId("Microsoft.Compute/virtualMachineScaleSets", "webApp-vmss")]',
        profiles: [
          {
    ...
    it("creates a CPU-based scaling policy with defaults", () => {
      const policy = createCpuScalingPolicy({
        name: "cpu-autoscale",
        targetResourceUri:
          '[resourceId("Microsoft.Compute/virtualMachineScaleSets", "app-vmss")]',
      }) as any;
    ...
    it("throws when required values are missing", () => {
      expect(() => createAutoScalePolicy({} as any)).toThrow(
        "Auto-scale policy requires a name",
      );
      expect(() => createAutoScalePolicy({ name: "test" } as any)).toThrow(
        "Auto-scale policy requires a targetResourceUri",
      );
      expect(() =>
        createAutoScalePolicy({
          name: "test",
      ...
      ).toThrow("Auto-scale policy requires at least one profile");
    });
  });
  ...
  describe("Metric Scale Rules", () => {
    ...
    it("throws when required values are missing", () => {
      expect(() => createMetricScaleRule({} as any)).toThrow(
        "Metric scale rule requires a metricName",
      );
      expect(() =>
        createMetricScaleRule({ metricName: "Percentage CPU" } as any),
      ).toThrow("Metric scale rule requires a numeric threshold");
    });
  });
  ...
  describe("Schedule Profiles", () => {
    ...
    it("throws when required values are missing", () => {
      expect(() => createScheduleProfile({} as any)).toThrow(
        "Schedule profile requires a name",
      );
      expect(() => createScheduleProfile({ name: "test" } as any)).toThrow(
        "Schedule profile requires capacity with minimum value",
      );
    });
  });
  ...
  describe("scale:autoscale.* helpers", () => {
    it("renders auto-scaling policy through Handlebars helper", () => {
      ...
      const result = helpers["scale:autoscale.policy"]({
        name: "test-autoscale",
        targetResourceUri:
          '[resourceId("Microsoft.Compute/virtualMachineScaleSets", "test-vmss")]',
        profiles: [
          {
            name: "Default",
  ...
  describe("Load Balancer and Application Gateway", () => {
    it("creates load balancer definition with VMSS backend", () => {
        ...
        frontendIPConfigurations: [
          {
            name: "publicFrontend",
            publicIpAddressId:
              "/subscriptions/000/resourceGroups/rg/providers/Microsoft.Network/publicIPAddresses/web-pip",
          },
        ],
        backendAddressPools: [
          {
            name: "vmssPool",
            vmssResourceId:
              "/subscriptions/000/resourceGroups/rg/providers/Microsoft.Compute/virtualMachineScaleSets/web-vmss",
          },
        ],
        probes: [
          {
      ...
      expect(lb.properties.loadBalancingRules[0].properties.backendPort).toBe(
        80,
      );
    ...
    it("creates application gateway definition with WAF configuration", () => {
        ...
        gatewayIPConfigurations: [
          {
            ...
            subnetId:
              "/subscriptions/000/resourceGroups/rg/providers/Microsoft.Network/virtualNetworks/vnet/subnets/appgw-subnet",
          },
        ],
        frontendIPConfigurations: [
          {
            name: "publicFrontend",
            publicIpAddressId:
              "/subscriptions/000/resourceGroups/rg/providers/Microsoft.Network/publicIPAddresses/appgw-pip",
          },
        ],
        frontendPorts: [
          {
      ...
      expect(
        appGw.properties.webApplicationFirewallConfiguration.firewallMode,
      ).toBe("Prevention");
      expect(
        appGw.properties.backendAddressPools[0].properties.backendAddresses,
      ).toHaveLength(1);
        ...
        frontendIPConfigurations: [
          {
            name: "public",
            publicIpAddressId:
              "/subscriptions/000/resourceGroups/rg/providers/Microsoft.Network/publicIPAddresses/pip",
          },
        ],
        backendAddressPools: [
          {
            name: "vmssPool",
            vmssResourceId:
              "/subscriptions/000/resourceGroups/rg/providers/Microsoft.Compute/virtualMachineScaleSets/vmss",
          },
        ],
        loadBalancingRules: [
          {
        ...
        gatewayIPConfigurations: [
          {
            name: "gwIp",
            subnetId:
              "/subscriptions/000/resourceGroups/rg/providers/Microsoft.Network/virtualNetworks/vnet/subnets/gw",
          },
        ],
        frontendIPConfigurations: [
          {
        ...
        requestRoutingRules: [
          {
            ...
            backendHttpSettingsName: "setting",
          },
        ],
      });
  ...
  describe("Traffic Manager and Multi-region", () => {
        ...
        endpoints: [
          {
            ...
            type: "AzureEndpoint",
            targetResourceId:
              "/subscriptions/000/resourceGroups/rg/providers/Microsoft.Compute/virtualMachineScaleSets/app-primary",
            priority: 1,
            location: "eastus",
          },
          {
            ...
            type: "AzureEndpoint",
            targetResourceId:
              "/subscriptions/000/resourceGroups/rg/providers/Microsoft.Compute/virtualMachineScaleSets/app-secondary",
            priority: 2,
            location: "westus",
          },
        ],
    ...
    it("validates Traffic Manager endpoint requirements", () => {
      expect(() =>
        createTrafficManagerEndpointConfig({
          ...
          type: "AzureEndpoint",
        } as TrafficManagerEndpointOptions),
      ).toThrow("Azure endpoints require a targetResourceId");
    });
      ...
      const plan = createMultiRegionDeploymentPlan({
        ...
        monitoring: {
          applicationInsightsResourceId:
            "/subscriptions/000/resourceGroups/rg/providers/Microsoft.Insights/components/app-insights",
        },
    ...
    it("creates failover plan with steps", () => {
        ...
        steps: [
          {
            ...
            automation: {
              logicAppResourceId:
                "/subscriptions/000/resourceGroups/rg/providers/Microsoft.Logic/workflows/notify",
            },
          },
          {
            ...
            validation: [
              ...
              "Confirm Traffic Manager routing",
            ],
          },
        ],
      });
      ...
      expect((plan as any).steps[1].validation).toContain(
        "Verify application availability",
      );
    });
    ...
    it("renders multi-region helpers via Handlebars", () => {
      const profileTemplate = Handlebars.compile(
        `{{{[scale:multiregion.profile] this}}}`,
      );

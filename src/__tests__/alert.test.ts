  ...
  describe("Error Handling", () => {
    test("alert:metricAlert should throw error when name missing", () => {
      expect(() => {
        ...
        (Handlebars.helpers["alert:metricAlert"] as any).call(null, {
          severity: 1,
          scopes: "[]",
          criteria: "[]",
        });
    ...
    test("alert:dynamicMetricAlert should throw error when scopes missing", () => {
      expect(() => {
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        (Handlebars.helpers["alert:dynamicMetricAlert"] as any).call(null, {
          name: "test",
          severity: 2,
          criteria: "[]",
        });
    ...
    test("alert:logAlert should throw error when query missing", () => {
      expect(() => {
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        (Handlebars.helpers["alert:logAlert"] as any).call(null, {
          name: "test",
          severity: 1,
          scopes: "[]",
        });
    ...
    test("alert:activityLogAlert should throw error when condition missing", () => {
      expect(() => {
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        (Handlebars.helpers["alert:activityLogAlert"] as any).call(null, {
          name: "test",
          scopes: "[]",
        });
    ...
    test("alert:actionGroup should throw error when shortName missing", () => {
      expect(() => {
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        (Handlebars.helpers["alert:actionGroup"] as any).call(null, {
          name: "test",
        });
    ...
    test("alert:smartGroup should throw error when scopes missing", () => {
      expect(() => {
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        (Handlebars.helpers["alert:smartGroup"] as any).call(null, {
          name: "test",
        });

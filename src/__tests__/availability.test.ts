...
describe("Availability Zones", () => {
  ...
  describe("validateZoneConfig", () => {
    it("should validate correct zone configuration", () => {
      const result = validateZoneConfig({ zones: ["1", "2", "3"] }, "eastus");
    ...
    it("should reject invalid zone numbers", () => {
      const result = validateZoneConfig({ zones: ["4" as any] }, "eastus");
    ...
    it("should warn for single zone deployment", () => {
      const result = validateZoneConfig({ singleZone: "1" }, "eastus");

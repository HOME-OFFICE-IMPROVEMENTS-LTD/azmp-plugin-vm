...
const COST_OPTIMIZATION_TEMPLATES: CostOptimizationTemplate[] = [
  ...
  },
  {
    ...
    metrics: ['Monthly spend trend', 'Instance runtime hours', 'Break-even analysis'],
    recommendedActions: [
  ...
  },
  {
    ...
    metrics: ['Inter-region egress', 'Zone-to-zone traffic', 'Content delivery usage'],
    recommendedActions: [
...
export function getCostOptimizationTemplate(id: string): CostOptimizationTemplate | null {

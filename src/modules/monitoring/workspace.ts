...
export function monitorLogAnalyticsWorkspace(this: any, options: any): string {
  ...
  const publicNetworkAccessForIngestion =
    hash.publicNetworkAccessForIngestion || "Enabled";
  const publicNetworkAccessForQuery =
    hash.publicNetworkAccessForQuery || "Enabled";

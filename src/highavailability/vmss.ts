  ...
  profiles: Array<{
    ...
    rules: Array<{
      ...
      metricTrigger: {
        ...
        timeGrain: string; // ISO 8601 duration
 ...
 */
export function validateVmssAutoscaleConfiguration(
  autoscaleConfig: VmssAutoscaleConfig,
  vmssConfig: VmssConfig
): string[] {
  const errors: string[] = [];
 ...
 */
export function generateVmssAutoscaleResource(
  autoscaleConfig: VmssAutoscaleConfig,
  vmssConfig: VmssConfig
): any {
 ...
 */
export function generateVmssParameters(vmssConfig: VmssConfig): any {
  if (!vmssConfig.enabled) {
    return {};
  }
...
export class VmssCLI {
  ...
  static getVmssExamples(): Array<{ name: string; description: string; config: Partial<VmssConfig> }> {
    return [
      {
        name: 'Web Tier VMSS',
  ...
  static getAutoscaleExamples(): Array<{ name: string; description: string; config: Partial<VmssAutoscaleConfig> }> {
    return [
      {

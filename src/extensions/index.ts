...
export function createExtensionHelpers() {
  ...
  helpers['ext:windows.monitoringAgent'] = function(workspaceId: string, workspaceKey: string) {
  ...
  helpers['ext:linux.omsAgent'] = function(workspaceId: string, workspaceKey: string) {
  ...
  helpers['ext:azureMonitorAgent'] = function(platform: 'Windows' | 'Linux', options: any) {
    const config = options.hash || {};
  ...
  helpers['ext:dependencyAgent'] = function(platform: 'Windows' | 'Linux', options: any) {
    const config = options.hash || {};
  ...
  helpers['ext:keyVault'] = function(platform: 'Windows' | 'Linux', options: any) {
    const config = options.hash || {};
  ...
  helpers['ext:get'] = function(name: string, category: ExtensionCategory) {
    return extensionsCatalog.find(ext => ext.name === name && ext.category === category);
  };

 ...
 * Get NSG rule by key
 */
export function getNsgRule(
  key: NsgRuleKey,
): (typeof NSG_RULES)[NsgRuleKey] | undefined {
 ...
 * Get all NSG rules
 */
export function getAllNsgRules(): Array<{
  key: NsgRuleKey;
 ...
 */
export function getNsgTemplate(
  key: NsgTemplateKey,
): (typeof NSG_TEMPLATES)[NsgTemplateKey] | undefined {
 ...
 */
export function getAllNsgTemplates(): Array<{
  key: NsgTemplateKey;
 ...
 */
export function validateNsgPriority(priority: number): {
  valid: boolean;
  error?: string;
} {
 ...
 * Validate port range
 */
export function validatePortRange(portRange: string): {
  valid: boolean;
  error?: string;
} {
  // Allow * for any port
 ...
 */
export function getServiceTagDescription(
  tag: keyof typeof SERVICE_TAGS,
): string {
 ...
 */
export function createNsgRule(
  config: Partial<NsgRuleConfig> & { name: string },
): NsgRuleConfig {
  return {
    name: config.name,

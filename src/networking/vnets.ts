 ...
 */
export function getServiceEndpointName(endpoint: keyof typeof SERVICE_ENDPOINTS): string {
 ...
 */
export function getDelegationName(delegation: keyof typeof SUBNET_DELEGATIONS): string {

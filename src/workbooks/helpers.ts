...
export function registerWorkbookHelpers(): void {
  ...
  Handlebars.registerHelper(
    "workbook:definition",
    function (templateId: string, options: any) {
      try {
  ...
  Handlebars.registerHelper(
    "workbook:kqlQuery",
    function (query: string, options: any) {
      try {
  ...
  Handlebars.registerHelper(
    ...
    function (resourceType: string, metricName: string, options: any) {
      try {
  ...
  Handlebars.registerHelper(
    "workbook:parameter",
    function (parameterName: string, parameterType: string, options: any) {
      try {
        ...
        return new Handlebars.SafeString(
          JSON.stringify(parameterItem, null, 2),
        );
      } catch (error) {
  ...
  Handlebars.registerHelper(
    "workbook:link",
    function (linkText: string, linkUrl: string, options: any) {
      try {
...
export const HELPER_DOCUMENTATION = {
  "workbook:definition": {
    ...
    syntax:
      '{{workbook:definition "template-id" subscriptionId="sub-id" vmName="vm-name"}}',
    parameters: {
  ...
  "workbook:metricsChart": {
    ...
    syntax:
      '{{workbook:metricsChart "resourceType" "metricName" title="Chart Title"}}',
    parameters: {
  ...
  "workbook:parameter": {
    ...
    syntax:
      '{{workbook:parameter "paramName" "paramType" displayName="Display Name"}}',
    parameters: {
      parameterName: "Required. Parameter name",
      parameterType:
        "Required. Parameter type (text, dropdown, timeRange, etc.)",
  ...
  "workbook:link": {
    ...
    syntax:
      '{{workbook:link "Link Text" "https://example.com" openInNewTab=true}}',
    parameters: {

...
import { advancedWorkbookTemplates } from "../monitoring/workbooks";

/**
 * VM Monitoring Templates (8 templates)
 * Focus on VM performance, health, security, and operational metrics
 */
const VM_MONITORING_TEMPLATES: WorkbookTemplate[] = [
  {
    id: "vm-performance-dashboard",
    name: "VM Performance Dashboard",
    description:
      "Comprehensive VM performance monitoring with CPU, memory, disk, and network metrics",
      ...
      items: [
        ...
        },
        {
          ...
          content: {
            version: "KqlItem/1.0",
            query:
              'Perf | where ObjectName == "Processor" and CounterName == "% Processor Time" | where TimeGenerated > ago(1h) | summarize avg(CounterValue) by bin(TimeGenerated, 5m), Computer | render timechart',
            size: 0,
        ...
        },
        {
          ...
          content: {
            version: "KqlItem/1.0",
            query:
              'Perf | where ObjectName == "Memory" and CounterName == "Available MBytes" | where TimeGenerated > ago(1h) | summarize avg(CounterValue) by bin(TimeGenerated, 5m), Computer | render timechart',
            size: 0,
  ...
  },
  {
    ...
    description:
      "Track VM uptime, availability, and heartbeat status across your infrastructure",
    category: "vm-monitoring",
      ...
      items: [
        ...
        },
        {
          ...
          content: {
            version: "KqlItem/1.0",
            query:
              'Heartbeat | where TimeGenerated > ago(24h) | summarize LastHeartbeat = max(TimeGenerated) by Computer | extend Status = iff(LastHeartbeat > ago(5m), "Online", "Offline") | project Computer, LastHeartbeat, Status',
            size: 0,
  ...
  },
  {
    ...
    description:
      "Security monitoring dashboard for VMs including security events, updates, and compliance status",
    category: "vm-monitoring",
      ...
      items: [
        ...
        },
        {
          ...
          content: {
            version: "KqlItem/1.0",
            query:
              "SecurityEvent | where TimeGenerated > ago(24h) | summarize count() by EventID, Activity | top 10 by count_",
            size: 0,
  ...
  },
  {
    ...
    description:
      "Cost optimization dashboard showing VM spending, rightsizing recommendations, and usage patterns",
    category: "vm-monitoring",
      ...
      items: [
        ...
        },
        {
          ...
          content: {
            version: "KqlItem/1.0",
            query:
              'Usage | where ResourceType == "Microsoft.Compute/virtualMachines" | summarize TotalCost = sum(PretaxCost) by ResourceName, MeterCategory | top 10 by TotalCost',
            size: 0,
  ...
  },
  {
    ...
    description:
      "Capacity planning dashboard for VM resources with growth trends and utilization forecasting",
    category: "vm-monitoring",
      ...
      items: [
        ...
        },
        {
          ...
          content: {
            version: "KqlItem/1.0",
            query:
              'Perf | where CounterName == "% Processor Time" and ObjectName == "Processor" | where TimeGenerated > ago(30d) | summarize avg(CounterValue) by bin(TimeGenerated, 1d), Computer | render timechart',
            size: 0,
  ...
  },
  {
    ...
    description:
      "Monitor VM backup status, compliance, and recovery point objectives across your environment",
    category: "vm-monitoring",
  ...
  },
  {
    ...
    description:
      "Network performance and connectivity analysis for VMs including bandwidth and latency metrics",
    category: "vm-monitoring",
  ...
  },
  {
    ...
    description:
      "Monitor VM extensions status, health, and performance across your virtual machine fleet",
    category: "vm-monitoring",
...
const ADVANCED_MONITORING_TEMPLATES: WorkbookTemplate[] =
  advancedWorkbookTemplates.map((template) => ({
    id: template.id,
    name: template.name,
 ...
 */
const APPLICATION_TEMPLATES: WorkbookTemplate[] = [
  {
    id: "app-performance-monitoring",
    name: "Application Performance Monitoring",
    description:
      "APM dashboard for applications running on VMs with response times, error rates, and throughput",
  ...
  },
  {
    ...
    description:
      "User behavior and analytics dashboard for applications with session data and user journeys",
    category: "application",
  ...
  },
  {
    ...
    description:
      "Error tracking dashboard with exception analysis, error trends, and impact assessment",
    category: "application",
  ...
  },
  {
    ...
    description:
      "Application dependency mapping and monitoring with service topology and health status",
    category: "application",
  ...
  },
  {
    ...
    description:
      "Application availability tracking with SLA compliance monitoring and uptime analysis",
    category: "application",
  ...
  },
  {
    ...
    description:
      "Custom application metrics dashboard with business KPIs and domain-specific measurements",
    category: "application",
 ...
 */
const INFRASTRUCTURE_TEMPLATES: WorkbookTemplate[] = [
  {
    id: "multi-vm-dashboard",
    name: "Multi-VM Dashboard",
    description:
      "Comprehensive dashboard for monitoring multiple VMs across resource groups and subscriptions",
  ...
  },
  {
    ...
    description:
      "Virtual Machine Scale Set monitoring with autoscale events, instance health, and scaling metrics",
    category: "infrastructure",
  ...
  },
  {
    ...
    description:
      "Load balancer monitoring dashboard with backend health, traffic distribution, and performance metrics",
    category: "infrastructure",
  ...
  },
  {
    ...
    description:
      "Network Security Group flow logs analysis with traffic patterns and security insights",
    category: "infrastructure",
  ...
  },
  {
    ...
    description:
      "DR monitoring dashboard with replication health, failover readiness, and recovery objectives",
    category: "infrastructure",
  ...
  },
  {
    ...
    description:
      "Infrastructure compliance dashboard with policy adherence, security standards, and audit results",
    category: "infrastructure",
 ...
 */
export class WorkbookTemplateManager {
   ...
   */
  public static getAllTemplates(): WorkbookTemplate[] {
  ...
  public static getTemplatesByCategory(
    category: WorkbookTemplate["category"],
  ): WorkbookTemplate[] {
    return this.ALL_TEMPLATES.filter(
   ...
   */
  public static getTemplate(templateId: string): WorkbookTemplate | null {
    return (
      this.ALL_TEMPLATES.find((template) => template.id === templateId) || null
    );
  }
   ...
   */
  public static searchTemplatesByTags(tags: string[]): WorkbookTemplate[] {
    return this.ALL_TEMPLATES.filter((template) =>
   ...
   */
  public static generateWorkbook(options: WorkbookGenerationOptions): any {
  ...
  private static applyCustomParameters(
    ...
    for (const [key, value] of Object.entries(parameters)) {
      ...
      updatedWorkbookString = updatedWorkbookString.replace(
   ...
   */
  public static validateTemplate(template: WorkbookTemplate): {
    isValid: boolean;
    errors: string[];
  } {
    const errors: string[] = [];
    ...
    if (
      !["vm-monitoring", "application", "infrastructure"].includes(
        template.category,
      )
    ) {
      errors.push(
        "Template category must be one of: vm-monitoring, application, infrastructure",
      );
    }
   ...
   */
  public static getTemplateStats(): {
    total: number;

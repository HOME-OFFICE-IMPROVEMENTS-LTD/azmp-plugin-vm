...
describe('Workbooks Module', () => {
  ...
  describe('WorkbookTemplateManager', () => {
    ...
    describe('getTemplatesByCategory', () => {
      it('should return 8 vm-monitoring templates', () => {
        const templates = WorkbookTemplateManager.getTemplatesByCategory('vm-monitoring');
      ...
      it('should return 6 application templates', () => {
        const templates = WorkbookTemplateManager.getTemplatesByCategory('application');
      ...
      it('should return 6 infrastructure templates', () => {
        const templates = WorkbookTemplateManager.getTemplatesByCategory('infrastructure');
        expect(templates).toHaveLength(6);
        templates.forEach((template: WorkbookTemplate) => {
    ...
    describe('getTemplate', () => {
      it('should return specific template by id', () => {
        const template = WorkbookTemplateManager.getTemplate('vm-performance-dashboard');
      ...
      it('should return null for unknown template id', () => {
        const template = WorkbookTemplateManager.getTemplate('unknown-template');
    ...
    describe('searchTemplatesByTags', () => {
      it('should find templates by monitoring tag', () => {
        const templates = WorkbookTemplateManager.searchTemplatesByTags(['monitoring']);
      ...
      it('should find templates by performance tag', () => {
        const templates = WorkbookTemplateManager.searchTemplatesByTags(['performance']);
        expect(templates.length).toBeGreaterThan(0);
        templates.forEach((template: WorkbookTemplate) => {
      ...
      it('should return empty array for non-existent tags', () => {
        const templates = WorkbookTemplateManager.searchTemplatesByTags(['non-existent-tag']);
    ...
    describe('validateTemplate', () => {
      ...
      it('should reject template with missing properties', () => {
        ...
        const result = WorkbookTemplateManager.validateTemplate(invalidTemplate);
  ...
  describe('Handlebars Helpers', () => {
    describe('workbook:definition helper', () => {
      it('should generate complete workbook definition', () => {
        const template = Handlebars.compile('{{workbook:definition "vm-performance-dashboard"}}');
      ...
      it('should handle unknown template gracefully', () => {
        const template = Handlebars.compile('{{workbook:definition "unknown-template"}}');
        const result = template({});
    ...
    describe('workbook:template helper', () => {
      it('should return template metadata', () => {
        const template = Handlebars.compile('{{workbook:template "vm-performance-dashboard"}}');
        const result = template({});
        expect(result).toBeTruthy();
        expect(typeof result).toBe('string');
      });
    ...
    describe('workbook:kqlQuery helper', () => {
      it('should generate KQL query item', () => {
        const template = Handlebars.compile('{{workbook:kqlQuery "Perf | where CounterName == \\"% Processor Time\\"" title="CPU Usage" size="0"}}');
        const result = template({});
        expect(result).toBeTruthy();
        expect(typeof result).toBe('string');
      ...
      it('should handle minimal parameters', () => {
        const template = Handlebars.compile('{{workbook:kqlQuery "Heartbeat"}}');
        const result = template({});
        expect(result).toBeTruthy();
    ...
    describe('workbook:metricsChart helper', () => {
      it('should generate metrics chart item', () => {
        const template = Handlebars.compile('{{workbook:metricsChart "CPU Metrics" "microsoft.compute/virtualmachines" "Percentage CPU" "Average"}}');
        const result = template({});
        expect(result).toBeTruthy();
        expect(typeof result).toBe('string');
      });
    ...
    describe('workbook:parameter helper', () => {
      it('should generate text parameter', () => {
        const template = Handlebars.compile('{{workbook:parameter "vmName" "text" "Virtual Machine Name" "myvm"}}');
        const result = template({});
        expect(result).toBeTruthy();
        expect(typeof result).toBe('string');
      });
      ...
      it('should generate dropdown parameter', () => {
        const template = Handlebars.compile('{{workbook:parameter "environment" "dropdown" "Environment" "" "[\\"prod\\", \\"staging\\", \\"dev\\"]"}}');
        const result = template({});
        expect(result).toBeTruthy();
        expect(typeof result).toBe('string');
      });
    ...
    describe('workbook:grid helper', () => {
      it('should generate grid item', () => {
        const template = Handlebars.compile('{{workbook:grid "VM List" "Virtual Machines" "Heartbeat | summarize by Computer"}}');
        const result = template({});
        expect(result).toBeTruthy();
        expect(typeof result).toBe('string');
      });
    ...
    describe('workbook:link helper', () => {
      it('should generate URL link', () => {
        const template = Handlebars.compile('{{workbook:link "External Link" "url" "https://docs.microsoft.com"}}');
        const result = template({});
        expect(result).toBeTruthy();
        expect(typeof result).toBe('string');
      });
    ...
    describe('workbook:export helper', () => {
      it('should generate export configuration', () => {
        const template = Handlebars.compile('{{workbook:export "excel" "VM Data Export"}}');
        const result = template({});
        expect(result).toBeTruthy();
        expect(typeof result).toBe('string');
      });
      ...
      it('should handle multiple formats', () => {
        const template = Handlebars.compile('{{workbook:export "excel,csv,json" "Multi-format Export"}}');
        const result = template({});
        expect(result).toBeTruthy();
        expect(typeof result).toBe('string');
      });
  ...
  describe('Template Content Validation', () => {
    ...
    it('should have valid categories', () => {
      const templates = WorkbookTemplateManager.getAllTemplates();
      const validCategories = ['vm-monitoring', 'application', 'infrastructure', 'advanced-monitoring', 'scaling-analytics', 'cost-optimization'];
  ...
  describe('Integration Tests', () => {
    ...
    it('should handle missing Handlebars helpers gracefully', () => {
      ...
      const unregisteredTemplate = Handlebars.compile('{{nonexistent:helper "test"}}');

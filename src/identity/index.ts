...
export function createIdentityHelpers() {
   ...
   */
  helpers["identity:managedidentity.userAssigned"] = function (
    identityId: string,
  ) {
    return JSON.stringify(
      managedidentity.userAssignedIdentity(identityId),
      null,
      2,
    );
  };
   ...
   */
  helpers["identity:managedidentity.multiple"] = function (
    userIdentityIds: string[],
  ) {
    return JSON.stringify(
      managedidentity.multipleIdentities(userIdentityIds),
      null,
      2,
    );
  };
   ...
   */
  helpers["identity:managedidentity.create"] = function (
    requirements: managedidentity.IdentityRequirements,
  ) {
    return JSON.stringify(
      managedidentity.createManagedIdentity(requirements),
      null,
      2,
    );
  };
  ...
  helpers["identity:managedidentity.recommendations"] = function (
    ...
    return JSON.stringify(
      managedidentity.getIdentityRecommendations(useCase),
      null,
      2,
    );
  };
   ...
   */
  helpers["identity:managedidentity.validate"] = function (
    config: managedidentity.ManagedIdentityConfig,
  ) {
    return JSON.stringify(
      managedidentity.validateManagedIdentityConfig(config),
      null,
      2,
    );
  };
  ...
  helpers["identity:managedidentity.roleAssignment"] = function (
    ...
    return JSON.stringify(
      managedidentity.createRoleAssignment(
        principalId,
        roleDefinitionId,
        scope,
      ),
   ...
   */
  helpers["identity:azuread.sshLogin"] = function (
    config?: azuread.AADSSHLoginConfig,
  ) {
   ...
   */
  helpers["identity:azuread.windowsLogin"] = function (
    config?: azuread.AADSSHLoginConfig,
  ) {
   ...
   */
  helpers["identity:azuread.conditionalAccess"] = function (
    policy: azuread.ConditionalAccessPolicy,
  ) {
   ...
   * VM access role
   */
  helpers["identity:azuread.vmAccessRole"] = function (
    roleType: "Administrator" | "User",
  ) {
  ...
  helpers["identity:azuread.create"] = function (
    ...
    return JSON.stringify(
      azuread.createAADIntegration(platform, features),
      null,
      2,
    );
  };
  ...
  helpers["identity:rbac.assignBuiltInRole"] = function (
    ...
    return JSON.stringify(
      rbac.assignBuiltInRole(principalId, roleName, scopeType, scopeId),
      null,
      2,
    );
  };
   ...
   * Create custom role
   */
  helpers["identity:rbac.createCustomRole"] = function (
    roleDefinition: rbac.CustomRoleDefinition,
  ) {
   ...
   * Create RBAC scope
   */
  helpers["identity:rbac.scope"] = function (
    scopeType: rbac.RBACScope,
    resourceName?: string,
  ) {
   ...
   */
  helpers["identity:rbac.template"] = function (
    assignment: rbac.RoleAssignmentConfig,
  ) {
  ...
  helpers["identity:rbac.customRole.vmExtension"] = function () {
    return JSON.stringify(
      rbac.customRoleTemplates.vmExtensionManager(),
      null,
      2,
    );
  };
   ...
   */
  helpers["identity:rbac.validate"] = function (
    assignment: rbac.RoleAssignmentConfig,
  ) {
  ...
  helpers["identity:compliance"] = function (framework: "soc2" | "hipaa") {
    const template = identityTemplates.find(
      (t) => t.name === `identity-compliance-${framework}`,
    );
    return template ? JSON.stringify(template, null, 2) : null;
  };
  ...
  helpers["identity:builtInRole"] = function (roleName: string) {
    return (
      (managedidentity.builtInRoles as Record<string, string>)[roleName] || null
    );
  };

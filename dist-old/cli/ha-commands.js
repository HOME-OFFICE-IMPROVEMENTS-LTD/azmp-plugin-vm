...
exports.HealthExtensionCLI = exports.VmssCLI = exports.LoadBalancerCLI = exports.HighAvailabilityCLI = exports.ProximityPlacementGroupCLI = void 0;
exports.registerHACommands = registerHACommands;
const ppg_1 = require("../highavailability/ppg");
Object.defineProperty(exports, "ProximityPlacementGroupCLI", { enumerable: true, get: function () { return ppg_1.ProximityPlacementGroupCLI; } });
const cluster_1 = require("../highavailability/cluster");
Object.defineProperty(exports, "HighAvailabilityCLI", { enumerable: true, get: function () { return cluster_1.HighAvailabilityCLI; } });
const loadbalancer_1 = require("../highavailability/loadbalancer");
Object.defineProperty(exports, "LoadBalancerCLI", { enumerable: true, get: function () { return loadbalancer_1.LoadBalancerCLI; } });
/**
 * Register HA CLI commands with parent VM command
 */
function registerHACommands(parentCommand) {
    ...
    haCommand
        ...
        .action((region) => {
        try {
            ppg_1.ProximityPlacementGroupCLI.checkRegion(region);
        }
        catch (error) {
    ...
    haCommand
        ...
        .action(() => {
        try {
            ppg_1.ProximityPlacementGroupCLI.listSupportedRegions();
        }
        catch (error) {
    ...
    haCommand
        ...
        .action((vmSize, region) => {
        try {
            ppg_1.ProximityPlacementGroupCLI.validateVmSize(vmSize, region);
        }
        catch (error) {
    ...
    haCommand
        ...
        try {
            ...
            cluster_1.HighAvailabilityCLI.listExamples();
        }
        catch (error) {
    ...
    haCommand
        ...
        .action(() => {
        try {
            cluster_1.HighAvailabilityCLI.showBestPractices();
        }
        catch (error) {
    ...
    haCommand
        ...
        try {
            ...
            if (options.region) {
                ...
                ppg_1.ProximityPlacementGroupCLI.checkRegion(options.region);
            }
            if (options.vmSize && options.region) {
                ppg_1.ProximityPlacementGroupCLI.validateVmSize(options.vmSize, options.region);
            }
    ...
    haCommand
        ...
        .action(() => {
        try {
            loadbalancer_1.LoadBalancerCLI.showBestPractices();
        }
        catch (error) {
    ...
    haCommand
        ...
        .action(() => {
        try {
            loadbalancer_1.LoadBalancerCLI.showExamples();
        }
        catch (error) {
    ...
    haCommand
        ...
        try {
            console.log('\n📊 VMSS Planning');
            console.log('='.repeat(40));
            const zones = options.zones.split(',').map((z) => z.trim());
    ...
    haCommand
        ...
        try {
            ...
            autoscaleExamples.forEach((example, index) => {
                console.log(`\n${index + 1}. ${example.name}`);
                console.log(`   ${example.description}`);
...
var vmss_1 = require("../highavailability/vmss");
Object.defineProperty(exports, "VmssCLI", { enumerable: true, get: function () { return vmss_1.VmssCLI; } });
var health_1 = require("../highavailability/health");
Object.defineProperty(exports, "HealthExtensionCLI", { enumerable: true, get: function () { return health_1.HealthExtensionCLI; } });

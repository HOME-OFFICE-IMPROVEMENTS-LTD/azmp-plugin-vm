...
exports.HELPER_DOCUMENTATION = void 0;
exports.registerWorkbookHelpers = registerWorkbookHelpers;
exports.getAvailableHelpers = getAvailableHelpers;
 ...
 */
function registerWorkbookHelpers() {
    // Helper 1: workbook:definition - Generate complete workbook definition
    handlebars_1.default.registerHelper("workbook:definition", function (templateId, options) {
        try {
            const template = templates_1.WorkbookTemplateManager.getTemplate(templateId);
            if (!template) {
            ...
            const workbook = templates_1.WorkbookTemplateManager.generateWorkbook(generationOptions);
            return new handlebars_1.default.SafeString(JSON.stringify(workbook, null, 2));
        }
        catch (error) {
    ...
    handlebars_1.default.registerHelper("workbook:template", function (templateId) {
        try {
            const template = templates_1.WorkbookTemplateManager.getTemplate(templateId);
            if (!template) {
                return `Error: Template '${templateId}' not found`;
            ...
            return new handlebars_1.default.SafeString(JSON.stringify(metadata, null, 2));
        }
        catch (error) {
    ...
    handlebars_1.default.registerHelper("workbook:kqlQuery", function (query, options) {
        try {
            const title = options.hash?.title || "KQL Query";
            const size = options.hash?.size || 0;
            const timeContext = options.hash?.timeContext || {
                durationMs: 3600000,
            }; // 1 hour default
            const kqlItem = {
            ...
            return new handlebars_1.default.SafeString(JSON.stringify(kqlItem, null, 2));
        }
        catch (error) {
    ...
    handlebars_1.default.registerHelper("workbook:metricsChart", function (resourceType, metricName, options) {
        try {
            ...
            return new handlebars_1.default.SafeString(JSON.stringify(metricsItem, null, 2));
        }
        catch (error) {
    ...
    handlebars_1.default.registerHelper("workbook:parameter", function (parameterName, parameterType, options) {
        try {
            ...
            return new handlebars_1.default.SafeString(JSON.stringify(parameterItem, null, 2));
        }
        catch (error) {
    ...
    handlebars_1.default.registerHelper("workbook:grid", function (query, options) {
        try {
            ...
            return new handlebars_1.default.SafeString(JSON.stringify(gridItem, null, 2));
        }
        catch (error) {
    ...
    handlebars_1.default.registerHelper("workbook:link", function (linkText, linkUrl, options) {
        try {
            ...
            if (linkType === "url") {
                ...
                linkItem.content.links[0].linkIsContextBlade = !openInNewTab;
            }
            return new handlebars_1.default.SafeString(JSON.stringify(linkItem, null, 2));
        }
        catch (error) {
    ...
    handlebars_1.default.registerHelper("workbook:export", function (options) {
        try {
            ...
            return new handlebars_1.default.SafeString(JSON.stringify(exportConfig, null, 2));
        }
        catch (error) {

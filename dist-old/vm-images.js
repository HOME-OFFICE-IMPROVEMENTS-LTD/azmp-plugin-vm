...
exports.VM_IMAGES = void 0;
exports.getVmImage = getVmImage;
exports.getAllVmImages = getAllVmImages;
exports.getVmImagesByOS = getVmImagesByOS;
exports.searchVmImages = searchVmImages;
exports.VM_IMAGES = {
    // Windows Server
    "windows-2022": {
...
function getVmImage(key) {
    return exports.VM_IMAGES[key];
}
function getAllVmImages() {
    return Object.entries(exports.VM_IMAGES).map(([key, image]) => ({ key, image }));
}
function getVmImagesByOS(os) {
    return Object.entries(exports.VM_IMAGES)
        .filter(([_, image]) => image.os === os)
        .map(([key, image]) => ({ key, image }));
}
function searchVmImages(query) {
    const lowerQuery = query.toLowerCase();
    return Object.entries(exports.VM_IMAGES)
        .filter(([key, image]) => key.toLowerCase().includes(lowerQuery) ||

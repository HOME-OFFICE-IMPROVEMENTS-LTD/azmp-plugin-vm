...
exports.LoadBalancerCLI = void 0;
exports.validateLoadBalancerConfiguration = validateLoadBalancerConfiguration;
exports.generateLoadBalancerResource = generateLoadBalancerResource;
exports.generateLoadBalancerParameters = generateLoadBalancerParameters;
exports.generatePublicIpResource = generatePublicIpResource;
/**
 * Validates load balancer configuration
 */
function validateLoadBalancerConfiguration(config) {
    const errors = [];
    // Basic validation
 ...
 */
function generateLoadBalancerResource(config) {
    const resource = {
 ...
 */
function generateLoadBalancerParameters(config) {
    const parameters = {
        [`${config.name}Name`]: {
            type: 'string',
 ...
 */
function generatePublicIpResource(config) {
    if (config.type !== 'public' || !config.frontend.publicIpName) {
        return null;
    }
    return {
...
exports.LoadBalancerCLI = LoadBalancerCLI;
exports.default = LoadBalancerCLI;

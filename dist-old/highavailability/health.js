...
exports.HealthExtensionCLI = void 0;
exports.validateHealthExtensionConfiguration = validateHealthExtensionConfiguration;
exports.generateApplicationHealthExtension = generateApplicationHealthExtension;
exports.generateCustomHealthMonitoringExtension = generateCustomHealthMonitoringExtension;
exports.generateHealthExtensionParameters = generateHealthExtensionParameters;
/**
 * Validates health extension configuration
 */
function validateHealthExtensionConfiguration(healthConfig, vmssConfig, lbConfig) {
    const errors = [];
 ...
 */
function generateApplicationHealthExtension(healthConfig, vmssConfig) {
 ...
 */
function generateCustomHealthMonitoringExtension(healthConfig) {
 ...
 */
function generateHealthMonitoringScript(probe) {
    if (probe.script) {
 ...
 */
function generateHealthExtensionParameters(healthConfig) {
    if (!healthConfig.applicationHealthExtension.enabled) {
        return {};
    }
    const parameters = {
 ...
 */
class HealthExtensionCLI {
    static async validateConfiguration(healthConfig, vmssConfig) {
    ...
    static getHealthExtensionBestPractices() {
        return [
    ...
    static getHealthExtensionExamples() {
        return [
            {
    ...
    static getHealthProbeTemplates() {
        return [
            {
...
exports.HealthExtensionCLI = HealthExtensionCLI;

...
exports.HighAvailabilityCLI = void 0;
exports.validateHAConfiguration = validateHAConfiguration;
exports.shouldDisableCostOptimization = shouldDisableCostOptimization;
/**
 * Validates HA configuration for conflicts and requirements
 */
function validateHAConfiguration(config) {
    const errors = [];
 ...
 */
function shouldDisableCostOptimization(haConfig) {
...
exports.HighAvailabilityCLI = HighAvailabilityCLI;

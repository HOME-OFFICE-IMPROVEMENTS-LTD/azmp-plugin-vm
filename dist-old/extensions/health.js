...
exports.generateWindowsHealthExtension = generateWindowsHealthExtension;
exports.generateLinuxHealthExtension = generateLinuxHealthExtension;
exports.generateHealthExtension = generateHealthExtension;
/**
 * Generates Windows health extension (Custom Script Extension)
 */
function generateWindowsHealthExtension(config) {
    if (!config.enabled) {
        return {};
    }
    const scriptContent = `
 ...
 */
function generateLinuxHealthExtension(config) {
    if (!config.enabled) {
        return {};
    }
 ...
 */
function generateHealthExtension(config, osType) {
    switch (osType) {
        case 'Windows':

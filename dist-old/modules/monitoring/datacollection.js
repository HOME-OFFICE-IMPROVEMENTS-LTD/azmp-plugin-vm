...
exports.monitorDataCollectionRule = monitorDataCollectionRule;
exports.registerDataCollectionHelpers = registerDataCollectionHelpers;
 ...
 * }}
 */
function monitorDataCollectionRule(options) {
    ...
    if (typeof dataSources === "string") {
        try {
            ...
            throw new Error("monitor:dataCollectionRule dataSources must be valid JSON");
        }
    }
    ...
    if (typeof destinations === "string") {
        try {
            ...
            throw new Error("monitor:dataCollectionRule destinations must be valid JSON");
        }
    }
    ...
    if (typeof dataFlows === "string") {
        try {
            ...
            throw new Error("monitor:dataCollectionRule dataFlows must be valid JSON");
        }
    }
    const result = {
...
function registerDataCollectionHelpers() {
    handlebars_1.default.registerHelper("monitor:dataCollectionRule", monitorDataCollectionRule);
}

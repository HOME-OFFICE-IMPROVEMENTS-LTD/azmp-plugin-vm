...
exports.alertActivityLogAlert = alertActivityLogAlert;
exports.registerActivityLogAlertHelpers = registerActivityLogAlertHelpers;
 ...
 * ```
 */
function alertActivityLogAlert(hash) {
    if (!hash || !hash.name) {
...
function registerActivityLogAlertHelpers() {
    handlebars_1.default.registerHelper("alert:activityLogAlert", alertActivityLogAlert);
}

...
exports.alertSmartGroup = alertSmartGroup;
exports.registerSmartGroupHelpers = registerSmartGroupHelpers;
...
function alertSmartGroup(hash) {
    ...
    if (groupingConfig) {
        actions.push({
            ...
            ...(groupingConfig.lookbackDuration && {
                lookbackDuration: groupingConfig.lookbackDuration,
            }),
        });
    }
...
function registerSmartGroupHelpers() {
    handlebars_1.default.registerHelper("alert:smartGroup", alertSmartGroup);
}

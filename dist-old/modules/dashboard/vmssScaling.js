...
exports.dashboardVmssScaling = dashboardVmssScaling;
exports.registerVmssScalingDashboardHelpers = registerVmssScalingDashboardHelpers;
const Handlebars = __importStar(require("handlebars"));
/**
 * Generate VMSS scaling dashboard with autoscale metrics
 */
function dashboardVmssScaling(options) {
    if (!options.name)
...
function registerVmssScalingDashboardHelpers() {
    Handlebars.registerHelper("dashboard:vmssScaling", function (options) {
        const opts = options?.hash || options;
        return new Handlebars.SafeString(dashboardVmssScaling.call(this, opts));
    });
}

...
exports.workbookVmDiagnostics = workbookVmDiagnostics;
exports.registerVmDiagnosticsWorkbookHelpers = registerVmDiagnosticsWorkbookHelpers;
const Handlebars = __importStar(require("handlebars"));
/**
 * Generate VM diagnostics workbook with detailed troubleshooting queries
 */
function workbookVmDiagnostics(options) {
    if (!options.name)
...
function registerVmDiagnosticsWorkbookHelpers() {
    Handlebars.registerHelper("workbook:vmDiagnostics", function (options) {
        const opts = options?.hash || options;
        return new Handlebars.SafeString(workbookVmDiagnostics.call(this, opts));
    });
}

...
exports.availabilityZones = void 0;
exports.getAvailableZones = getAvailableZones;
exports.supportsAvailabilityZones = supportsAvailabilityZones;
exports.zonalVM = zonalVM;
exports.zoneRedundantDisk = zoneRedundantDisk;
exports.zoneRedundantIP = zoneRedundantIP;
exports.availabilityZoneSLA = availabilityZoneSLA;
exports.recommendZoneDistribution = recommendZoneDistribution;
exports.validateZoneConfig = validateZoneConfig;
exports.availabilityZonesBestPractices = availabilityZonesBestPractices;
exports.getZoneSupportedRegions = getZoneSupportedRegions;
/**
 ...
 */
function getAvailableZones(location) {
 ...
 */
function supportsAvailabilityZones(location) {
 ...
 * ```
 */
function zoneRedundantDisk(diskName, zones) {
    return {
 ...
 * ```
 */
function zoneRedundantIP(ipName, zones) {
    return {
 ...
 */
function availabilityZoneSLA(vmCount, zoneCount) {
 ...
 */
function recommendZoneDistribution(vmCount) {
    if (vmCount === 1) {
        return {
            zones: ["1"],
            vmPerZone: [1],
 ...
 */
function validateZoneConfig(config, location) {
    const errors = [];
    const warnings = [];
 ...
 */
function availabilityZonesBestPractices() {
    return `
 ...
 */
function getZoneSupportedRegions() {
    return [
        // Americas
        "eastus",
        "eastus2",

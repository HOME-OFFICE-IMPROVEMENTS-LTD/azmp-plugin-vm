...
exports.advancedWorkbookTemplates = exports.AdvancedWorkbookGenerator = void 0;
/**
 * Advanced Workbook Template Generator
 * Combines performance, cost, and scaling analytics
 */
class AdvancedWorkbookGenerator {
    /**
    ...
    static generateVmPerformanceWorkbook(options = {}) {
        ...
        items.push(this.createHeaderItem("VM Performance & Cost Analytics", "Comprehensive analysis of virtual machine performance, cost optimization opportunities, and scaling patterns"));
        // Parameters section
    ...
    static generateVmssScalingWorkbook(options = {}) {
        const items = [];
        // Header
        items.push(this.createHeaderItem("VMSS Scaling Analytics", "Advanced autoscaling analysis with load patterns, predictive insights, and cost optimization"));
        // Parameters
    ...
    static generateCostOptimizationWorkbook(options = {}) {
        const items = [];
        // Header
        items.push(this.createHeaderItem("VM Cost Optimization", "Comprehensive cost analysis with performance-aware recommendations"));
        // Parameters
    ...
    static createHeaderItem(title, description) {
        return {
            type: 1, // text
            content: {
                json: `# ${title}\n\n${description}\n\n---`,
    ...
    static createParametersItem(type = "vm") {
        return {
            type: 9, // parameters
            content: {
                parameters: type === "vmss"
    ...
    static createVmOverviewSection() {
        return {
            type: 3,
            content: {
                query: `
...
| project 
    ...
    static createPerformanceAnalysisSection() {
        return [
            {
                type: 1,
                content: {
...
| project TimeGenerated, MetricType, CounterName, Value, Status
    ...
    static createCostAnalysisSection() {
        return [
            {
                type: 1,
                content: {
...
| project 
    ...
    static createScalingAnalyticsSection() {
        return [
            {
                type: 1,
                content: {
...
| project 
    ...
    static createRecommendationsSection() {
        return [
            {
                type: 1,
                content: {
...
\`\`\`
    ...
    static createVmssOverviewSection() {
        return {
            type: 3,
            content: {
                query: `
...
| project TimeGenerated, MetricName, AvgValue = round(AvgValue, 1), Status
    ...
    static createLoadPatternSection() {
        return [
            {
                type: 1,
                content: {
...
| project 
    ...
    static createAutoscalePerformanceSection() {
        return [
            {
                type: 1,
                content: {
...
| project 
    ...
    static createPredictiveAnalysisSection() {
        return [
            {
                type: 1,
                content: {
...
| project 
    ...
    static createScalingCostSection() {
        return [
            {
                type: 1,
                content: {
...
| project 
    ...
    static createScalingOptimizationSection() {
        return [
            {
                type: 1,
                content: {
...
| project 
    ...
    static createCostOverviewSection() {
        return [
            {
                type: 1,
                content: {
...
| project 
    ...
    static createRightsizingSection() {
        return [
            {
                type: 1,
                content: {
...
| project 
    ...
    static createReservedInstanceSection() {
        return [
            {
                type: 1,
                content: {
...
| project 
    ...
    static createSpotInstanceSection() {
        return [
            {
                type: 1,
                content: {
...
| project 
    ...
    static createPerformanceImpactSection() {
        return [
            {
                type: 1,
                content: {
...
| project 
    ...
    static createCostActionItemsSection() {
        return [
            {
                type: 1,
                content: {
...
exports.AdvancedWorkbookGenerator = AdvancedWorkbookGenerator;
/**
 * Advanced workbook template registry
 */
exports.advancedWorkbookTemplates = [
    {

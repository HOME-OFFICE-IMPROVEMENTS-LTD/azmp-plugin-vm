...
exports.SUBNET_DELEGATIONS = exports.SERVICE_ENDPOINTS = exports.VNET_TEMPLATES = void 0;
exports.calculateUsableIPs = calculateUsableIPs;
exports.validateCIDR = validateCIDR;
exports.isIPInCIDR = isIPInCIDR;
exports.getVNetTemplate = getVNetTemplate;
exports.getAllVNetTemplates = getAllVNetTemplates;
exports.getServiceEndpointName = getServiceEndpointName;
exports.getDelegationName = getDelegationName;
/**
 * Pre-configured VNet templates for common scenarios
 */
exports.VNET_TEMPLATES = {
    /**
 ...
 */
function getVNetTemplate(key) {
    return exports.VNET_TEMPLATES[key];
}
/**
 * Get all VNet templates
 */
function getAllVNetTemplates() {
    return Object.entries(exports.VNET_TEMPLATES).map(([key, template]) => ({
        key: key,
        template,
    }));
}
 ...
 */
function getServiceEndpointName(endpoint) {
    return exports.SERVICE_ENDPOINTS[endpoint];
}
/**
 * Get subnet delegation display name
 */
function getDelegationName(delegation) {
    return exports.SUBNET_DELEGATIONS[delegation];
}

...
exports.HelperUsageValidator = void 0;
exports.validateHelperUsage = validateHelperUsage;
exports.getHelperCategories = getHelperCategories;
 ...
 */
class HelperUsageValidator {
    templateContent;
    context;
    constructor(templateContent, context = {}) {
     ...
     */
    validateHelperPatterns(result) {
        // Check for VM size validation
        if (this.templateContent.includes("vmSize") &&
        ...
        if (this.templateContent.includes("osImage") &&
        ...
        if (this.templateContent.includes("Microsoft.Compute/virtualMachines")) {
            if (!this.templateContent.includes("trustedLaunch") &&
            ...
            if (!this.templateContent.includes("diskEncryption") &&
     ...
     */
    validateDeprecatedHelpers(result) {
     ...
     */
    validateRequiredHelpers(result) {
        ...
        if (this.templateContent.includes("Microsoft.Network/networkInterfaces")) {
            if (!this.templateContent.includes("createVNet") &&
        ...
        if (this.templateContent.includes("availabilityZones") &&
...
exports.HelperUsageValidator = HelperUsageValidator;
/**
 * Validate helper usage in template
 *
 ...
 */
function validateHelperUsage(templateContent, context = {}) {
 ...
 * @returns boolean
 */
function isHelperAvailable(helperName) {
    const allHelpers = Object.values(HELPER_CATEGORIES).flat();

...
exports.backup = exports.BackupPresets = void 0;
exports.recoveryServicesVault = recoveryServicesVault;
exports.backupPolicy = backupPolicy;
exports.enableVMBackup = enableVMBackup;
exports.estimateBackupStorage = estimateBackupStorage;
exports.validateBackupPolicy = validateBackupPolicy;
exports.backupBestPractices = backupBestPractices;
/**
 ...
 * ```
 */
function recoveryServicesVault(config) {
    return {
 ...
 * ```
 */
function enableVMBackup(config) {
 ...
 */
function estimateBackupStorage(vmSizeGB, dailyRetention = 30, weeklyRetention = 12, monthlyRetention = 12, compressionRatio = 0.5) {
 ...
 */
function validateBackupPolicy(config) {
    const errors = [];
    const warnings = [];
    // Validate name
    ...
    if (config.instantRpRetentionRangeInDays) {
        if (config.instantRpRetentionRangeInDays < 1 ||
...
exports.backup = {
    ...
    backupPolicy,
    enableVMBackup,
    BackupPresets: exports.BackupPresets,
